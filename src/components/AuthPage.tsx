      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50">
        <div className="w-full max-w-5xl flex bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-800 relative overflow-hidden">
            ...
            <div className="absolute top-20 left-20 w-32 h-32 bg-white/10 rounded-full blur-xl float1"></div>
            <div className="absolute bottom-40 right-20 w-24 h-24 bg-purple-300/20 rounded-full blur-lg float2"></div>
            <div className="absolute top-1/2 left-10 w-16 h-16 bg-blue-300/20 rounded-full blur-md float3"></div>
            <div className="absolute top-32 right-32 w-20 h-20 bg-white/15 rounded-full blur-lg float4"></div>
            <div className="absolute bottom-20 left-1/3 w-28 h-28 bg-cyan-300/20 rounded-full blur-xl float5"></div>
            <div className="absolute top-2/3 right-16 w-12 h-12 bg-pink-300/25 rounded-full blur-sm float6"></div>
